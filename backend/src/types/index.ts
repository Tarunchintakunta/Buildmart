...
export type WorkerSkill = 'coolie' | 'mason' | 'electrician' | 'plumber' | 'carpenter' | 'painter' | 'welder' | 'helper';
export type WorkerStatus = 'working' | 'waiting';
export type DriverType = 'shop_driver' | 'freelance';
export type VerificationStatus = 'pending' | 'approved' | 'rejected';
export type OrderStatus = 'pending' | 'accepted' | 'processing' | 'out_for_delivery' | 'delivered' | 'cancelled';
export type AgreementStatus = 'draft' | 'pending_signature' | 'active' | 'completed' | 'terminated';
export type LaborRequestStatus = 'pending' | 'accepted' | 'in_progress' | 'completed' | 'cancelled';
export type TransactionType = 'deposit' | 'withdrawal' | 'payment' | 'hold' | 'release' | 'refund';
